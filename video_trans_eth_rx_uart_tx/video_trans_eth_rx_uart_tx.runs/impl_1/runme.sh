...
HD_PWD='C:/Users/KANG Jian/Desktop/video_trans_pro/video_trans_eth_rx_uart_tx/video_trans_eth_rx_uart_tx.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rx_eth_tx_uart.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rx_eth_tx_uart.tcl -notrace
