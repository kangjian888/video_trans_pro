...
HD_PWD='C:/Users/KANG Jian/Desktop/video_trans_pro/video_trans_eth_rx_uart_tx/video_trans_eth_rx_uart_tx.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rx_eth_tx_uart.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rx_eth_tx_uart.tcl
