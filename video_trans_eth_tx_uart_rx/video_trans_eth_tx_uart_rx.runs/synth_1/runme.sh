...
HD_PWD='C:/Users/KANG Jian/Desktop/video_trans_pro/video_trans_eth_tx_uart_rx/video_trans_eth_tx_uart_rx.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eth_tx_uart_rx.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eth_tx_uart_rx.tcl
