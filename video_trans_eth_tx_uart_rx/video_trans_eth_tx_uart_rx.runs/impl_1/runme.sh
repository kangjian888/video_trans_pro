...
HD_PWD='C:/Users/KANG Jian/Desktop/video_trans_pro/video_trans_eth_tx_uart_rx/video_trans_eth_tx_uart_rx.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log eth_tx_uart_rx.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source eth_tx_uart_rx.tcl -notrace
